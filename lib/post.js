...
friendlyPix.Post = function () {
  ...
  function _class() {var _this = this;_classCallCheck(this, _class);
    ...
    $(document).ready(function () {
      ...
      _this.postElement = $('.fp-post', _this.postPage);
   ...
   */_createClass(_class, [{ key: 'clone', value: function clone() 
    {
      var clone = new friendlyPix.Post();
     ...
     */ }, { key: 'loadPost', value: function loadPost(
     ...
     */ }, { key: 'clear', value: function clear() 
    {
      ...
      var newElement = friendlyPix.MaterialUtils.cloneElementWithTextField(this.postElement);
    ...
    picUrl, thumbUrl) {var _this5 = this;
